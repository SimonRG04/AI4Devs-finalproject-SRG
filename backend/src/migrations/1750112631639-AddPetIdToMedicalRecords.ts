...
export class AddPetIdToMedicalRecords1750112631639 implements MigrationInterface {
    name = 'AddPetIdToMedicalRecords1750112631639'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_ai_diagnoses_appointment_id"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_appointments_scheduled_at"`);
        ...
        await queryRunner.query(`ALTER TABLE "medical_records" ADD "pet_id" integer`);
      ...
      "sunday": {"start": "09:00", "end": "13:00", "isAvailable": false}
        ...
        await queryRunner.query(`ALTER TABLE "medical_records" ADD CONSTRAINT "FK_00f48fa86cd43404c7c3f1cf691" FOREIGN KEY ("pet_id") REFERENCES "pets"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "appointments" DROP COLUMN "priority"`);
        await queryRunner.query(`ALTER TABLE "appointments" ADD "priority" character varying(20) DEFAULT 'NORMAL'`);
        await queryRunner.query(`ALTER TABLE "appointments" DROP COLUMN "type"`);
        await queryRunner.query(`ALTER TABLE "appointments" ADD "type" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "ai_diagnoses" DROP COLUMN "results"`);
        await queryRunner.query(`ALTER TABLE "ai_diagnoses" ADD "results" json`);
        await queryRunner.query(`ALTER TABLE "medical_records" DROP COLUMN "follow_up_date"`);
        ...
        await queryRunner.query(`ALTER TABLE "vaccinations" DROP COLUMN "expiration_date"`);
        await queryRunner.query(`ALTER TABLE "vaccinations" ADD "expiration_date" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "vaccinations" DROP COLUMN "administration_date"`);
        await queryRunner.query(`ALTER TABLE "vaccinations" ADD "administration_date" TIMESTAMP NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "medical_records" DROP COLUMN "pet_id"`);
        ...
        await queryRunner.query(`ALTER TABLE "ai_diagnoses" ADD "symptoms" text`);
