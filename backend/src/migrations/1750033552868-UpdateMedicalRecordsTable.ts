...
export class UpdateMedicalRecordsTable1750033552868 implements MigrationInterface {
    name = 'UpdateMedicalRecordsTable1750033552868'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "medical_records" ADD "title" character varying(200)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "medical_records" DROP COLUMN "title"`);
